CodeMirror.defineMode("karel-en", function(conf, parserConf) {
    ...
    'while', 'if', 'else', 'def', 'return', 'inc', 'dec', 'gpsx', 'gpsy',
    'append', 'del', 'pop'];
    var commontypes = ['true', 'false', 'home', 'north', 'empty', 'acid', 'anchor', 'bone', 'box', 'bush', 'cactus', 'corn', 'fire', 'gem', 'jellyfish', 'mark', 'mine', 'palm', 'plant', 'radiation', 'rock', 'scorpion', 'skull', 'stone', 'stump', 'tomb', 'torpedo', 'tray', 'tree', 'wall', 'water', 'wood', 'bag', 'baket', 'cart', 'chest', 'vault', 'net', 'bin', 'trash', 'toilet', 'bowl', 'nugget', 'pumpkin', 'spider', 'snake', 'rose', 'tulip', 'apple', 'cherry', 'eye', 'brain', 'candy', 'book', 'key', 'pie', 'gears', 'coin', 'gun', 'ammo', 'grenade', 'pill', 'medkit', 'radio', 'bomb', 'starfish', 'pearl', 'crab', 'shoe', 'beads', 'ribbon', 'ring', 'map', 'hat', 'pipe', 'lens', 'phone', 'watch', 'rug', 'shield', 'mask', 'ball', 'orchid', 'sword', 'chip', 'basket', 'lollipop', 'table', 'chair', 'barrel', 'oil', 'baseball', 'tools', 'orange', 'banana', 'potato', 'coconut', 'pot', 'crate', 'bottle', 'popcorn'];
