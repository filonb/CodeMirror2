...
/*    function intersectRect(r1, r2) {
      r1.top = Math.max(r1.top, r2.top);
      r1.bottom = Math.min(r1.bottom, r2.bottom);
      r1.left = Math.max(r1.left, r2.left);
      r1.right = Math.min(r1.right, r2.right);
      return r1;
    }*/
    ...
    function scrollCursorIntoView() {
      ...
      var outerBox = getNthAncestor(lineSpace, 13).getBoundingClientRect(); // added as a helper function to handle cursor scrolling
      if (coords.y + box.top < outerBox.top) doScroll = false;
